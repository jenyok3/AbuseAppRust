...
### Оновлення сьогодні
- Вимкнено збереження/відновлення позиції та розміру вікна (Tauri): завжди центр при старті.
- Settings: вкладка "Теми" (Зима активна), Осінь/Весна/Літо тимчасово вимкнені.
- Ефект "Сніг": є повзунок швидкості.
- Спроба додати листя/сакуру/світлячків відкачена; ефекти вимкнені.
