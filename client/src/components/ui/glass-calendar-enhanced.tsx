...
interface GlassCalendarEnhancedProps extends React.HTMLAttributes<HTMLDivElement> {
  selectedDate?: Date;
...
// --- MAIN COMPONENT ---
export const GlassCalendarEnhanced = React.forwardRef<HTMLDivElement, GlassCalendarEnhancedProps>(
  ({ className, selectedDate: propSelectedDate, onDateSelect, ...props }, ref) => {
    ...
    return (
      <div
        ...
        {...props}
      >
        {/* Header: Month Display and Navigation */}
...
GlassCalendarEnhanced.displayName = "GlassCalendarEnhanced";
