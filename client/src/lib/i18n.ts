...
const translations = {
  uk: {
    ...
    "settings.concurrent_opened.label": "Одночасно відкритих",
    "settings.concurrent_opened.tooltip": "Скільки акаунтів програма може відкрити одночасно. Більша кількість потребує більше оперативної пам'яті.",
    "settings.concurrent_opened.aria.telegram": "Інформація про одночасно відкриті акаунти",
    "settings.concurrent_opened.aria.chrome": "Інформація про одночасно відкриті акаунти Chrome",
    "settings.telegram.launch_speed.label": "Швидкість запуску",
    "settings.telegram.launch_speed.fast": "Швидко",
    "settings.telegram.launch_speed.balanced": "Баланс",
    "settings.telegram.launch_speed.stable": "Стабільно",
  ...
  en: {
    ...
    "settings.concurrent_opened.label": "Opened simultaneously",
    "settings.concurrent_opened.tooltip": "How many accounts the app can open at the same time. Higher values require more RAM.",
    "settings.concurrent_opened.aria.telegram": "Info about Telegram simultaneous openings",
    "settings.concurrent_opened.aria.chrome": "Info about Chrome simultaneous openings",
    "settings.telegram.launch_speed.label": "Launch speed",
    "settings.telegram.launch_speed.fast": "Fast",
    "settings.telegram.launch_speed.balanced": "Balanced",
    "settings.telegram.launch_speed.stable": "Stable",
    "common.save": "Save",
  ...
  ru: {
    ...
    "settings.concurrent_opened.label": "Открыто одновременно",
    "settings.concurrent_opened.tooltip": "Сколько аккаунтов приложение может открыть одновременно. Большее значение требует больше оперативной памяти.",
    "settings.concurrent_opened.aria.telegram": "Информация об одновременно открытых аккаунтах",
    "settings.concurrent_opened.aria.chrome": "Информация об одновременно открытых аккаунтах Chrome",
    "settings.telegram.launch_speed.label": "Скорость запуска",
    "settings.telegram.launch_speed.fast": "Быстро",
    "settings.telegram.launch_speed.balanced": "Баланс",
    "settings.telegram.launch_speed.stable": "Стабильно",
